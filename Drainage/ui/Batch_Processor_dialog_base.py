...
# Form implementation generated from reading ui file 'D:\Batch_Processor_dialog_base.ui'
#
...
class Ui_WatershedDialogBase(object):
    def setupUi(self, WatershedDialogBase):
        ...
        WatershedDialogBase.resize(460, 356)
        ...
        self.lblCatchment.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        ...
        self.txtFilledDEM = QtWidgets.QLineEdit(self.groupBox_3)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txtFilledDEM.sizePolicy().hasHeightForWidth())
        self.txtFilledDEM.setSizePolicy(sizePolicy)
        self.txtFilledDEM.setObjectName("txtFilledDEM")
        self.gridLayout_3.addWidget(self.txtFilledDEM, 1, 1, 1, 2)
        self.groupBox = QtWidgets.QGroupBox(self.groupBox_3)
        self.groupBox.setLayoutDirection(QtCore.Qt.LeftToRight)
        self.groupBox.setObjectName("groupBox")
        self.gridLayout_2 = QtWidgets.QGridLayout(self.groupBox)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.txtThresholdValueForStream = QtWidgets.QLineEdit(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txtThresholdValueForStream.sizePolicy().hasHeightForWidth())
        self.txtThresholdValueForStream.setSizePolicy(sizePolicy)
        self.txtThresholdValueForStream.setMinimumSize(QtCore.QSize(60, 0))
        self.txtThresholdValueForStream.setObjectName("txtThresholdValueForStream")
        self.gridLayout_2.addWidget(self.txtThresholdValueForStream, 0, 4, 1, 1)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.txtStreamVector.sizePolicy().hasHeightForWidth())
        ...
        self.lblStream.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
    ...
    def retranslateUi(self, WatershedDialogBase):
        ...
        WatershedDialogBase.setWindowTitle(_translate("WatershedDialogBase", "Batch Processor"))
        ...
        self.label_6.setText(_translate("WatershedDialogBase", "(Flow accumulation value)"))
